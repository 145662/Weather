...
//  Weather
//
//  Created by Stan Gl on 17.11.22.
//  Copyright © 2022 ru.NataliyaGlazkova. All rights reserved.
//
...
//количество ячеек
    ...
    func requestData(city: String) {
        var params = ["q" : city]
        AF.request(url, method: .get, parameters: params).response {
            [self] response in
...
//alert
    ...
    // funkciya proveryaet, dobavlen li takoy gorod v spisok
